<template>
  <div
    class="-top-16 z-40 absolute flex flex-col justify-center items-center bg-transparent opacity-[.35] dark:opacity-50 w-full max-w-full! h-[60vh] overflow-hidden transition-bg pointer-events-none">
    <div class="absolute opacity-60 jumbo animate"></div>
  </div>
